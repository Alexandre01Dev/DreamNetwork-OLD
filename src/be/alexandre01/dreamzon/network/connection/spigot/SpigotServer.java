...
public class SpigotServer {
    ...
    private static be.alexandre01.dreamzon.network.connection.spigot.server.Server server;
    ...
    public static void setServer(be.alexandre01.dreamzon.network.connection.spigot.server.Server server){
